...
\fexo{TS-Spé-A2}{PGCD-Bezout-Gauss}{}
\tableofcontents
...
\begin{exercice}
Soit l'égalité de Bézout : \og {Soit $a$ et $b$ deux entiers non nuls et $D$ leur PGCD. Il existe un couple d'entiers relatifs telle que $au+bv=D$} \fg .
\begin{enumerate}
\item Démontrer le théorème de Bézout \og {$a$ et $b$ sont premiers entre eux si, et seulement si, il existe un couple d'entiers relatifs $(u;v)$ tel que $au+bv=1$} \fg .
...
\begin{exercice}
En utilisant le théorème de de Gauss, démontrer le corollaire du théorème de Gauss :\og {Si $b$ et $c$ divisent $a$ et si $b$ et $c$ sont premiers entre eux, alors $bc$ divise $a$} \fg .
\end{exercice}
...
\begin{exercice}
  Soit l'identité de Bézout : \og {Soit $a$ et $b$ deux entiers non
    nuls et $D$ leur PGCD. Il existe un couple d'entiers relatifs
    tel que $au + bv = D$} \fg .

  Démontrer le corollaire du théorème de Bézout : \og {L'équation
    $ax + by = c$ admet des solutions entières si, et seulement si,
    $c$ est un multiple du $PGCD(a\ ;\ b)$} \fg .
\end{exercice}
